...
import com.Practice3.AuthPractice.jwt.JwtUtils;
...
import com.Practice3.AuthPractice.payload.*;
...
public class AuthController {
    ...
    @Autowired
    CustomUserServiceInterface customUserServiceInterface;
...
//      set the authentication
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        return ResponseEntity.ok(new MessageResponse("Todo user registered successfully!"));
    }

    @GetMapping("/user")
    public ResponseEntity<?> getUserDetails(@AuthenticationPrincipal UserDetails userDetails) {
        User user = customUserServiceInterface.findByUsername(userDetails.getUsername());
